...
baml_function_sync!(Chat(system: impl AsRef<str> + BamlEncode, messages: &[types::ChatMessage], tools: &[types::ToolDefinition], ) -> (stream_types::Union2ListToolCallOrString, types::Union2ListToolCallOrString));
