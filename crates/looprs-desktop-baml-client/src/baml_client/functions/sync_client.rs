...
baml_function_sync!(AnalyzeIntent(user_input: impl AsRef<str> + BamlEncode, conversation_history: impl AsRef<str> + BamlEncode, ) -> (stream_types::UserIntent, types::UserIntent));

baml_function_sync!(AnalyzeSentiment(text: impl AsRef<str> + BamlEncode, context: impl AsRef<str> + BamlEncode, ) -> (stream_types::MessageAnalysis, types::MessageAnalysis));

baml_function_sync!(AssessSystemHealth(metrics: impl AsRef<str> + BamlEncode, ) -> (stream_types::SystemHealth, types::SystemHealth));

baml_function_sync!(DetectAnomalies(metrics_history: impl AsRef<str> + BamlEncode, current_metrics: impl AsRef<str> + BamlEncode, ) -> (Vec<stream_types::DataAnomaly>, Vec<types::DataAnomaly>));

baml_function_sync!(GenerateContextAwareUi(goal: impl AsRef<str> + BamlEncode, context: &types::UiContext, ) -> (stream_types::ContextAwareUiNode, types::ContextAwareUiNode));

baml_function_sync!(GenerateDynamicText(template: impl AsRef<str> + BamlEncode, variables: &std::collections::HashMap<String, String>, sentiment: &types::Sentiment, mood: &types::Mood, ) -> (String, String));

baml_function_sync!(GenerateSentimentAwareUi(goal: impl AsRef<str> + BamlEncode, state_json: impl AsRef<str> + BamlEncode, sentiment_analysis: impl AsRef<str> + BamlEncode, ) -> (stream_types::SentimentUiNode, types::SentimentUiNode));

baml_function_sync!(GenerateUiTree(goal: impl AsRef<str> + BamlEncode, state_json: impl AsRef<str> + BamlEncode, ) -> (stream_types::UiNode, types::UiNode));
