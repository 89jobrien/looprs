...
"#;
    ...
    fn test_load_multiple_skills_nested() {
        ...
        fs::write(rust_testing.join("SKILL.md"), r#"---
name: rust-testing
triggers:
  - "cargo test"
---
...
"#).unwrap();
        ...
        fs::write(rust_errors.join("SKILL.md"), r#"---
...
"#).unwrap();
    ...
    fn test_load_with_precedence_repo_overrides_user() {
        ...
        fs::write(user_skill.join("SKILL.md"), r#"---
name: shared-skill
triggers:
  - "user trigger"
---
...
"#).unwrap();
        ...
        fs::write(repo_skill.join("SKILL.md"), r#"---
name: shared-skill
triggers:
  - "repo trigger"
---
...
"#).unwrap();
        ...
        let mut registry = SkillRegistry::new();
        let count = registry.load_with_precedence(user_temp.path(), repo_temp.path()).unwrap();
...
"#).unwrap();
        ...
        let mut registry = SkillRegistry::new();
        let count = registry.load_with_precedence(
